...
import { Autocomplete, Button, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, FormControlLabel, Input, InputLabel, Select, Switch, MenuItem, TextField, IconButton, Chip } from "@mui/material";
...
const CreateEventDialog = ({ readCategories, readPromoters, uploadFile, title, dialog, onSubmit }) => {
    ...
    const handleFeaturedImage = (e, onChange) => {
        e.preventDefault();
        const file = e.target.files[0];
        onChange(process.env.REACT_APP_BACKEND_BASE_URL + "/uploads/" + file.name)
                        ...
                        <div className="form-row">
                            ...
                            <div style={{ flexBasis: "50%" }}>
                                <div className="form-column">
                                    <img src="/placeholder.svg" width={200} alt="placeholder" />
                                    <Field name="featuredImage">
                                        {props => <label {...props.input} onChange={e => handleFeaturedImage(e, props.input.onChange)} htmlFor="contained-button-file">
...
export default withPromoterService(withCategoryService(withEventService(withFileService(CreateEventDialog))));